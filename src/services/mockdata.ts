export const mockData = [
   ...
   },
   {
      ...
      "Version": "1.6.1",
      "Category": "build",
      "Description": "This Task builds Java/Kotlin/Groovy/Scala source into a container image using Google's Jib tool.Jib works with Maven and Gradle projects, and this template is for Maven projects",
      "Ratings": "",
      "YAML": {
         "apiVersion": "tekton.dev/v1alpha1",
         "kind": "Task",
   ...
   },
   {
      ...
      "Version": "",
      "Category": "build",
      "Description": "It contains Tekton Task which can be used to Build and Serve Knative compatible applications (i.e., OpenWhisk Actions) on Kubernetes.",
      "Ratings": "",
      "YAML": {
         "apiVersion": "tekton.dev/v1alpha1",
         "kind": "Task",
